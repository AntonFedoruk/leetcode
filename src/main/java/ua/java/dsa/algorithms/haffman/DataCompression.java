package ua.java.dsa.algorithms.haffman;
...
public class DataCompression {
    ...
    private static void fileCompressTest() {
        try {
            ...
            String content = new String(Files.readAllBytes(Paths.get("/home/anton/My programs/demo/src/main/resources/Ybiti_peresmishnika_1407342674.txt")));
            ...
            File file = new File("/home/anton/My programs/demo/src/main/resources/Ybiti_peresmishnika_compressed.huf");
            ...
            Files.write(Paths.get("/home/anton/My programs/demo/src/main/resources/Ybiti_peresmishnika_decompressed.txt"), decoded.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
