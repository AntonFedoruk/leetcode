package ua.java.dsa.algorithms.haffmanadapt;
...
public class HuffmanEncoderStream extends OutputStream {
    ...
    EncodingModelRefreshing encodingModel;
    ...
    public HuffmanEncoderStream(EncodingModelRefreshing encodingModel, OutputStream outStream) {
